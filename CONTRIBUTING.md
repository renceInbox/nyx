...
License
- This project is licensed under the PolyForm Noncommercial License 1.0.0. By contributing, you agree that your contributions are licensed under the same license.
- For commercial use of the project, please contact the maintainer to discuss a commercial license.
